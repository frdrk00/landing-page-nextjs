...
const Footer = () => {
  return (
    <section
      id="footer"
      className="flex items-center justify-center sm:my-20 my-10"
    >
      <div className="items-center justify-center space-y-10">
        <div className="sm:grid grid-cols-2 gap-20">
          <div className="flex flex-row">
            <div className="sm:space-y-10 space-y-4">
              ...
              <p className="sm:text-[16px] text-[12px] font-poppins text-blue-200 text-start">
          ...
          <div className="sm:grid grid-cols-3 gap-4 max-sm:flex items-center justify-between max-sm:mt-10">
            <div className="grid grid-rows-4 gap-4">
              <h1 className="text-blue-200 text-base font-semibold leading-5 uppercase">
                služby
              </h1>
              <h1 className="text-blue-200 text-base font-normal leading-6">
                Marketing
              </h1>
              <h1 className="text-blue-200 text-base font-normal leading-6">
                Analytics
        ...
        <div className="flex justify-between">
          <div>
            <p className="text-blue-200 sm:text-[16px] text-[12px]">
              &copy; 2023 <span className="text-[#6F95FE]">SpaceSolutions</span>
            </p>
          </div>
          <div className="flex flex-row space-x-[24px] text-blue-200 max-sm:pr-4">
            <Facebook size={24} />
            <Instagram size={24} />
            <Twitter size={24} />
            <Github size={24} />
