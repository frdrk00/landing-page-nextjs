...
const MenuItem = ({ menu, index }: MenuItemProps) => {
  const [isHovered, setIsHovered] = useState(false)

  return (
    <a
      href={menu.uri}
      className="w-12 h-12 rounded-full flex items-center justify-center group cursor-pointer hover:bg-gradient-to-br hover:from-primary hover:to-secondary "
